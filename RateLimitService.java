...
import com.google.common.cache.Cache; // Changed import
...
public class RateLimitService {
    ...
    private final Cache<User, Bucket> cache; // Changed type to Cache
    ...
    private RateLimitService(int tokensPerInterval, Duration intervalDuration, int maximumCacheSize, Duration cacheDuration) {
        ...
        this.cache = CacheBuilder.newBuilder() // Changed to CacheBuilder
    ...
    public ConsumptionProbe rateLimit(User user, Token token) {
        Bucket bucket = cache.get(user, this::newBucket); // Changed from getUnchecked
